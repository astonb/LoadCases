...
extern SemaphoreHandle_t ResetSyncSemphr;
//////////////////////////////////////////////////////////////////
...
void uart_init(u32 bound){
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource2,GPIO_AF_USART2); //GPIOA2复用
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource3,GPIO_AF_USART2); //GPIOA3复用
...
void USART1_IRQHandler(void)                	//串口1中断服务程序
{
	...
	if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)  //接收中断(接收到的数据必须是0x0d 0x0a结尾)
	{
		...
		if(Res == '!')
		{
			xSemaphoreGiveFromISR(ResetSyncSemphr,&xHigherPriorityTaskWoken);
